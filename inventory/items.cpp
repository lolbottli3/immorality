...
{ (int)ItemDefinitionIndex::WEAPON_CZ75A,		"CZ75-A" },
...
{ (int)ItemDefinitionIndex::WEAPON_GALILAR,		"Galil-AR" },
...
{ (int)ItemDefinitionIndex::WEAPON_M4A1_SILENCER,       "M4A1-S" },
{ (int)ItemDefinitionIndex::WEAPON_M4A1,		"M4A4" },
...
{ (int)ItemDefinitionIndex::WEAPON_HKP2000,		"P2000" },
...
{ (int)ItemDefinitionIndex::WEAPON_USP_SILENCER,	    "USP-S" },
